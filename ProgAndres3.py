...
time.sleep(4)
pyautogui.click(55,350) #Click en el cuadro: Cook
time.sleep(2)
pyautogui.click(55,380) #Click en el cuadro: Dupage
time.sleep(2)
pyautogui.click(55,415) #Click en el cuadro: Kane
time.sleep(2)
pyautogui.click(55,445) #Click en el cuadro: Kendall
time.sleep(2)
pyautogui.click(293,350) #Click en el cuadro: Lake
time.sleep(1)
pyautogui.click(293,380) #Click en el cuadro: McHenry
time.sleep(1)
pyautogui.click(293,410) #Click en el cuadro: Will
time.sleep(1)
